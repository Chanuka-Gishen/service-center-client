...
import { PAY_SC_EXPENSES } from 'src/constants/payment-source';
import { expensePaymentSchema } from 'src/schema/add-expenses-schema';
import { empAdvancePaySchema } from 'src/schema/emp-advance-pay-schema';

export const AddEmpPaymentDialog = ({ open, isLoading, handleOpenClose, handleConfirm }) => {
  return (
    <Dialog
      open={open}
    ...
    >
      <DialogTitle id="alert-dialog-title">Add Employee Off-Cycle Advance Payment</DialogTitle>
      ...
      <Formik
        ...
        validationSchema={empAdvancePaySchema}
        onSubmit={(values) => {
