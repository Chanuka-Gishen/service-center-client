...
import { GENDER_MALE, GENDERS } from 'src/constants/gender';
import { EmployeeValidationSchema } from 'src/schema/register-emp-schema';
...
export const RegisterEmployeeDialog = ({ open, isLoading, handleOpenClose, handleConfirm }) => {
  return (
    <Dialog
      open={open}
