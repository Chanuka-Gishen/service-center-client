...
import { EmpAddAttendenceDialog } from '../components/emp-add-att-dialog';
...
export const AttendenceTabView = ({
  tableHeaders,
  pagination,
  searchParams,
  anchorEl,
    ...
    <Container>
      ...
      {isOpenUploadDlg && (
        <EmpAttendenceDialog
          ...
          handleUpload={handleUploadAttendenceRecords}
          isLoading={isLoadingAddAttendences}
        />
      )}
      {isOpenAddDlg && (
        <EmpAddAttendenceDialog
          open={isOpenAddDlg}
          employees={empSelectables}
          initialValues={initialValues}
          handleOpenClose={handleToggleAddDialog}
          handleSubmit={handleAddAttendenceRecords}
          isLoading={isLoadingAddDailyAtt}
