...
export const AddExpenseDialog = ({ open, isLoading, handleOpenClose, handleConfirm }) => {
  return (
    <Dialog
      open={open}
    ...
    >
      <DialogTitle id="alert-dialog-title">Add Expenses Payment</DialogTitle>
      ...
      <Formik
        ...
        validationSchema={expensePaymentSchema}
        onSubmit={(values) => {
                ...
                <Grid size={{ xs: 12, sm: 12, lg: 6 }}>
                  ...
                  >
                    ...
                    <Select
                      ...
                      onBlur={handleBlur}
                    >
                      {PAY_SC_EXPENSES.map((item, index) => (
